---
title: "Salary to Hourly Calculator India: CTC to Per Hour Rate"
description: "Convert your annual CTC to hourly, daily, weekly and monthly rate. Free salary to hourly rate calculator for India with working days and hours per day settings."
date: 2026-05-15
lastmod: 2026-05-15
type: "calculator"
url: /salary/salary-to-hourly-calculator/
keywords: "salary to hourly calculator india, ctc to hourly rate, annual salary to hourly, per hour salary calculator india"
categories:
- Salary Calculators
author: vignesh
ai_summary:
- Divides annual CTC by working months, days, and hours to get hourly rate
- Default: 22 working days/month, 8 hours/day (standard Indian corporate)
- Useful for freelancers quoting hourly rates or comparing job offers
- Does not account for leaves, overtime, or bonuses, CTC only
- Your take-home per hour is lower, use the TakeHome Calculator for that
---
...
{{< infographic-stat
  number="₹568/hr"
  label="Effective hourly rate on a ₹12 LPA CTC"
  sub="Assuming 22 working days/month, 8 hours/day" >}}
...
On an hourly basis, take-home is closer to ₹450/hour, not ₹568. Use the [CTC to In-Hand Calculator](/salary/takehome-calculator/) to get the exact post-tax number, then divide by your annual working hours.
