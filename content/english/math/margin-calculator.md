...
description: "Free profit margin calculator for India. Calculate gross profit margin %, markup %, or find the right selling price from your cost and target margin."
date: 2026-05-15
lastmod: 2026-05-15
type: "calculator"
url: /math/margin-calculator/
keywords: "profit margin calculator, margin calculator india, markup calculator, gross margin calculator, selling price calculator"
categories:
- Math Calculators
author: vignesh
ai_summary:
- Profit margin = (Selling price – Cost) ÷ Selling price × 100
- Markup = (Selling price – Cost) ÷ Cost × 100, always higher than margin %
- A 50% markup gives a 33.3% margin, not 50%
- Use the "Find Selling Price" tab to reverse-engineer price from a target margin
- GST is applied on top of selling price, factor that into your pricing
---
...
{{< infographic-stat
  number="33.3%"
  label="Profit margin when you buy at ₹500 and sell at ₹750"
  sub="Markup is 50%, but margin is only 33.3%" >}}
...
Use the [GST Calculator](/gst/gst-calculator/) to separate the tax component before running margin calculations.
...
The margin calculator handles per-unit math. For EMI on business loans or capital, check the [EMI Calculator](/loan/emi-calculator/).
