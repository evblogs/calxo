...
lastmod: 2026-04-25
type: "calculator"
url: /investment/lumpsum-calculator/
keywords: "lumpsum calculator, lumpsum investment calculator, mutual fund lumpsum calculator, one time investment calculator, future value calculator, india, calxo"
categories:
...
Yes for FD if you're using **annual** compounding (most banks use quarterly — use the [FD calculator](/investment/fd-calculator/) instead). For PPF specifically, the picture is different because PPF accepts annual contributions, has a 15-year lock-in, and the rate changes quarterly. Use the dedicated PPF calculator (coming soon) for accurate PPF projections.
