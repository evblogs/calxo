...
{{< takehome-calculator ctc="7500000" >}}
...
{{< infographic-stat
  number="₹3,80,482"
  label="Monthly in-hand from ₹75L CTC (new regime, Karnataka, 50% basic)"
  sub="FY 2025-26 - income tax ₹18,51,435/year incl. 10% surcharge" >}}
...
New regime wins by about ₹12,155/month even against a full old-regime deduction stack. At ₹75L the old-regime deductions are too small relative to income to flip the result. The lever that still moves real money is employer NPS under 80CCD(2), deductible in both regimes, worth up to 10% of basic. On a ₹37.5L basic that is ₹3.75L of contribution, saving roughly ₹1,33,500 in tax. See the [NPS tax benefit calculator](/tax/nps-tax-benefit-calculator/).

## Related calculators

- [Take-Home Salary Calculator](/salary/takehome-calculator/) - run your fixed CTC for the real baseline
- [Income Tax Calculator (FY 2025-26)](/tax/income-tax-calculator/) - slab tax with surcharge and cess
- [Old vs New Tax Regime](/tax/old-vs-new-tax-regime/) - confirm which wins at your deductions
- [NPS Tax Benefit Calculator](/tax/nps-tax-benefit-calculator/) - the 80CCD(2) lever for high earners
- [Capital Gains Calculator](/tax/capital-gains-calculator/) - for the ESOP and RSU side of your package

Also see: [60 lakh CTC breakdown](/blog/60-lakh-ctc-take-home-salary/) for the step below, and [1 crore CTC breakdown](/blog/1-crore-ctc-take-home-salary/) for the next level.
...
All figures: new regime, Karnataka PT, 50% basic structure, fixed pay, FY 2025-26. Use the [Take-Home Calculator](/salary/takehome-calculator/) for your exact CTC and structure.
