---
title: "PPF vs ELSS: Which 80C Investment Actually Wins in 2026"
description: "PPF gives 7.1% tax-free for 15 years. ELSS targets 12-14% but with 12.5% LTCG tax above ₹1.25L. After tax, equity wins for 10+ year goals, but only if you can hold through volatility. The real answer is to use both."
date: 2026-04-25
lastmod: 2026-04-25
author: vignesh
...
This article breaks down the math, the tax treatment, and the situations where each wins. The numbers come from the [PPF calculator](/investment/ppf-calculator/) and the [SIP calculator](/investment/sip-calculator/) (for ELSS, which is structurally a SIP into an equity mutual fund).

## Quick comparison

| Feature | PPF | ELSS |
|---|---|---|
| Lock-in | 15 years (extendable in 5-year blocks) | 3 years per instalment |
| Returns | 7.1% (notified, government-set) | 12-14% expected (market-linked) |
| Risk | Sovereign-guaranteed | Equity market risk |
| Annual cap | ₹1.5 lakh (statutory) | No cap (₹1.5L for 80C deduction) |
| Tax on returns | Fully tax-free (EEE status) | LTCG 12.5% above ₹1.25L/yr exemption |
| Liquidity post-lock | Annual partial withdrawal allowed | Fully liquid after 3 years per instalment |
| 80C eligible | Yes | Yes |
| Allowed under new tax regime | Investment is fine, but no 80C deduction | Same, investment is fine, no deduction |

{{< infographic-compare
  left-tag="Sovereign safe" left-title="PPF" left-num="7.1%" left-label="Guaranteed, fully tax-free, 15-year lock-in"
  right-tag="Equity, market-linked" right-title="ELSS" right-num="12-14%" right-label="Expected CAGR, 3-yr lock per instalment, LTCG above ₹1.25L"
...
| Investment | Total invested | Maturity (15 yrs) | Effective post-tax for 30% slab |
|---|---|---|---|
...
| Investment | Total invested | Year-15 value |
|---|---|---|
...
Use the [PPF calculator](/investment/ppf-calculator/) to see what your annual PPF contribution becomes at the current 7.1% rate over 15-30 years (with extensions). Use the [SIP calculator](/investment/sip-calculator/) for ELSS projections at your assumed CAGR.

For the tax savings on the 80C portion (under old regime), the [income tax calculator](/tax/income-tax-calculator/) shows the actual rupee impact of claiming the deduction.
