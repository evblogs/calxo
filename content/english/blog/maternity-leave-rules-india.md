...
categories:
- Salary
tags: ["maternity leave", "maternity benefit act", "salary", "HR", "women at work"]
ai_summary:
...
related_calcs:
  - { label: "Maternity Leave Calculator", url: "/salary/maternity-leave-calculator/" }
...
{{< infographic-stat
  number="26 weeks"
  label="Paid maternity leave for your first two children under the Maternity Benefit Act, 1961"
  sub="182 calendar days, at full average daily wage" >}}
...
{{< infographic-flow
  title="Working out your maternity leave dates"
  step1="First or second child?|If yes, 26 weeks. Third child onward, 12 weeks."
  step2="Choose your pre-delivery weeks|Up to 8 weeks before the due date, 6 for the 12-week case."
  step3="Leave start = due date minus those weeks|Take 4 weeks before a 20 Nov due date and leave starts 23 Oct."
  step4="Rejoin = leave start plus 182 days|That single date is what your handover plan gets built around."
>}}
...
`Maternity benefit = ₹3,000 × 182 days = ₹5,46,000`
...
The biggest one is the date error Meghna nearly made: counting maternity leave forward from delivery and forgetting the pre-delivery weeks. Run your dates through the [maternity leave calculator](/salary/maternity-leave-calculator/) and you'll never get the rejoin date wrong.

The second is assuming maternity benefit is tax-free. It isn't. The pay is part of your salary and gets taxed at your slab, the same as your normal income, unlike gratuity which has its own exemption. If you want to see what your regular monthly pay looks like after tax and PF, the [take-home salary calculator](/salary/takehome-calculator/) does that, and the [EPF calculator](/salary/epf-calculator/) shows how your provident fund keeps building. Your PF contributions continue on the maternity benefit too.
...
If you're also tracking your service for other employment benefits, the [gratuity calculator](/salary/gratuity-calculator/) is worth a look, since maternity leave counts as continuous service and doesn't break your gratuity clock.
