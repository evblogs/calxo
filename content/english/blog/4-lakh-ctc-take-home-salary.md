...
{{< takehome-calculator ctc="400000" >}}
...
{{< infographic-stat
  number="₹28,332"
  label="Monthly in-hand from ₹4L CTC (standard structure, Karnataka)"
  sub="FY 2025-26 - zero income tax, 85% of CTC" >}}
...
The ₹2,000/month going into PF is part of that. It is not a deduction in the painful sense. Your employer matches it with another ₹2,000, so ₹4,000 a month is being saved on your behalf at about 8.25% tax-free. Watch it compound with the [EPF calculator](/salary/epf-calculator/).
...
Every rung up to ₹13L CTC stays tax-free under the new regime. Each raise in these years lands almost entirely in your hand. When your appraisal letter arrives, run it through the [salary hike calculator](/salary/salary-hike-calculator/) to see the real monthly gain.

## Related calculators

- [Take-Home Salary Calculator](/salary/takehome-calculator/) - plug in your exact structure and city
- [EPF Calculator](/salary/epf-calculator/) - see how your PF grows over the years
- [Gratuity Calculator](/salary/gratuity-calculator/) - what you receive after 5 years
- [Income Tax Calculator (FY 2025-26)](/tax/income-tax-calculator/) - confirm your zero-tax position
- [Salary Hike Calculator](/salary/salary-hike-calculator/) - work out your next appraisal

Also see: [3 lakh CTC breakdown](/blog/3-lakh-ctc-take-home-salary/) for the step below, and [5 lakh CTC breakdown](/blog/5-lakh-ctc-take-home-salary/) for the next level.
