---
title: "What is CTC in Salary? CTC vs In-Hand Salary Explained with Examples"
description: "CTC (Cost to Company) is not your take-home salary. It includes employer PF, gratuity, and perks. Here's exactly what CTC means, what you actually get, and how to calculate your in-hand."
date: 2026-04-29
lastmod: 2026-04-29
author: vignesh
categories:
- Salary
tags: ["CTC", "Salary", "Take-home salary", "In-hand salary"]
related_calcs:
...
Use the [take-home salary calculator](/salary/takehome-calculator/) to get your exact number.
...
1. **Fixed vs variable split** — "₹12 LPA (fixed ₹10L + variable ₹2L)" means only ₹10L is guaranteed
2. **Is gratuity included in CTC?** — Ask HR explicitly. Some companies exclude it, some include it
3. **ESOPs** — If the letter includes stock value in the total, strip it out for cash flow planning
4. **One-time components** — Joining bonus is usually paid in the first month and recovered if you leave within 1–2 years
