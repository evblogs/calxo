...
| Basic Salary          | 50,000         |
| HRA                   | 20,000         |
| Special Allowance     | 21,595         |
| **Gross Salary**      | 91,595         |
| Employee PF (12% basic)| 6,000          |
| Professional Tax      | 200-300        |
| Income Tax (new regime)| 0              |
| **Net Take-Home**     | 85,395  |

So, your take-home is roughly ₹85,395 per month in Bengaluru, after all deductions. If you want to check for your own city or exact structure, use the [take-home salary calculator](/salary/takehome-calculator/) on Calxo.
...
| City        | State        | Professional Tax (annual) | Monthly Take-Home (₹) |
|-------------|--------------|--------------------------|------------------------|
| Bengaluru   | Karnataka    | ₹2,400                | 85,395                 |
| Mumbai      | Maharashtra  | ₹2,500                | 85,387                 |
| Delhi       | Delhi        | ₹0                    | 85,595                 |
| Hyderabad   | Telangana    | ₹2,400                | 85,395                 |
| Chennai     | Tamil Nadu   | ₹2,400                | 85,395                 |

Delhi is the only major city with no professional tax, so you get about ₹300 extra every month compared to Mumbai or Bengaluru. For other cities, check the relevant PT rate. If you want to compare your take-home for different CTCs, see the [10 lakh CTC breakdown](/blog/10-lakh-ctc-take-home-salary/) and [15 lakh CTC breakdown](/blog/what-15-lakh-ctc-actually-means/).
...
So, the old regime only wins if your deductions cross ₹2.8 lakh. For most ₹12 lakh CTC earners, this is not the case. New regime is almost always better unless you are paying very high rent and maxing out every deduction. For a deeper dive, see our [old vs new tax regime comparison](/blog/old-vs-new-tax-regime-fy-2025-26/).
...
The exempt amount is the lowest of these three: ₹84,000 per year, or ₹7,000 per month. This is the tax-free portion of your HRA. The rest is taxable. For your own numbers, the [HRA exemption calculator](/salary/hra-calculator/) is the fastest way to run these scenarios.
