...
{{< takehome-calculator ctc="700000" >}}
...
New regime wins for nearly everyone at ₹7L CTC. Use the [old vs new regime calculator](/tax/old-vs-new-tax-regime/) only if you have a parent's health insurance to claim or are paying significant rent.
...
The ₹42,000/year already going to EPF is your forced retirement saving. Add ₹10,000/month SIP into a flexi-cap or index fund and your wealth-building actually starts. Many people at this salary feel they have nothing to save. Run the [SIP calculator](/investment/sip-calculator/) on ₹10,000/month at 12% for 30 years. It is roughly ₹3.5 crore.

## Negotiating an upgrade

A ₹7L starter is decent for Tier-2 cities but tight in Bengaluru or Mumbai metros. After 18-24 months and a reasonable performance review, target ₹10-12 lakh. Use the [salary hike calculator](/salary/salary-hike-calculator/) to model what a 30-40% jump actually looks like in monthly take-home.

## Related calculators

- [Take-Home Salary Calculator](/salary/takehome-calculator/): plug in your structure, city, and EPF mode
- [EPF Calculator](/salary/epf-calculator/): project your retirement corpus from monthly contributions
- [Income Tax Calculator](/tax/income-tax-calculator/): confirm zero tax under new regime
- [HRA Exemption Calculator](/salary/hra-calculator/): relevant only if you choose old regime
- [Salary Hike Calculator](/salary/salary-hike-calculator/): plan your next raise
