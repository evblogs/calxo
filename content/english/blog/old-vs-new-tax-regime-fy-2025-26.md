...
If you declare your regime preference in your annual investment declaration, yes. Errors usually come from default settings (employer assumes new regime if you don't declare) or from claiming deductions you can't actually claim. Cross-check using the [take-home calculator](/salary/takehome-calculator/).
