...
{{< takehome-calculator ctc="6000000" >}}
...
{{< infographic-stat
  number="₹3,12,783"
  label="Monthly in-hand from ₹60L CTC (new regime, Karnataka, 50% basic)"
  sub="FY 2025-26 - income tax ₹13,79,904/year incl. 10% surcharge" >}}
...
The new regime wins clearly at ₹60L, even against a fully loaded old-regime deduction stack. The deductions that helped at ₹15L to ₹20L are now a small fraction of total income, so they move the needle far less. The one lever that still works in both regimes is employer NPS under Section 80CCD(2), which deducts up to 10% of basic. At ₹30L basic that is ₹3L of tax-deductible contribution, saving roughly ₹1,06,800 in tax. Model it with the [NPS tax benefit calculator](/tax/nps-tax-benefit-calculator/) before your next salary revision.
...
- [NPS Tax Benefit Calculator](/tax/nps-tax-benefit-calculator/) - the 80CCD(2) lever that works in both regimes
- [EPF Calculator](/salary/epf-calculator/) - project your PF corpus

Also see: [50 lakh CTC breakdown](/blog/50-lakh-ctc-take-home-salary/) for the step below, and [75 lakh CTC breakdown](/blog/75-lakh-ctc-take-home-salary/) for the next level.
